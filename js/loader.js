...
function bootLoader(){
	...
	var ldr_html="<div align='center' style='height:80;width:500;overflow:hidden;position:relative;left:-210'><table style=\"font-family:tahoma;font-size:63%;opacity:.2;filter:alpha(opacity=20);background-image:url('"+img+"');height:80px;width:80px;overflow:hidden;\"><tr valign='middle'><td align='center'></td></tr></table>";
	ldr_html+="<div style='position:relative;top:-60;z-index:1;font-size:200%;font-family:tahoma;color:#99ccbb;letter-spacing:2px;'><b>PIXELMANCER</b></div></div>"
	ldr_html+="<div style='z-index:2;position:relative;top:-20;'><div align='left' id='bootBar' step='0' max='8' style='position:relative;left:-60;overflow:hidden;height:2px;width:200px;background-color:#444444;'></div>";
